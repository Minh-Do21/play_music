...
class FlutterNotificationCenter {
  ...
  static FlutterNotificationCenter _sharedCenter =
  ...
  static void subscribe({
    ...
    if (_sharedCenter._channelObservers[channel]?[observer] == null) {
      _sharedCenter._channelObservers[channel]?[observer] = onNotification;
    } else {
      print('Observer is already subscribed to the channel $channel');
    }
  }
