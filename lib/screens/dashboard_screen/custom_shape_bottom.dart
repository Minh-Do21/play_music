...
class CustomBottomSharp extends NotchedShape {
  /// Creates a [CustomBottomSharp].
  ///
  /// The same object can be used to create multiple shapes.
  const CustomBottomSharp();
  ...
  /// the guest circle.
  // (amirh): add an example diagram here.
  @override
  Path getOuterPath(Rect host, Rect? guest) {
    ...
    final double notchRadius1 = guest.width / 3.0;
    ...
    return Path()
      ...
      ..arcToPoint(
        p[3]!,
        radius: Radius.circular(notchRadius1),
        clockwise: false,
      )
